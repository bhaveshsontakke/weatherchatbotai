...
const KNOWN_CITIES = [
  'fetri', 'khandala', 'nagpur', 'wardha', 'mumbai', 'pune', 'delhi', 'bangalore', 'bengaluru', 'hyderabad',
...
function extractLocation(message, previousLocation = 'Fetri') {
...
function processMessageContext(conversationId, message) {
  const context = conversationContext.get(conversationId) || { lastLocation: 'Fetri', history: [] };
