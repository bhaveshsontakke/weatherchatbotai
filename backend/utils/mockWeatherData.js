...
const CITIES_DB = {
  fetri: { name: 'Fetri', state: 'Maharashtra', country: 'IN', baseTemp: 31, condition: 'Partly Cloudy', icon: '02d', humidity: 64, windSpeed: 14, uv: 7, pressure: 1012, visibility: 8, rainProb: 35 },
  nagpur: { name: 'Fetri', state: 'Maharashtra', country: 'IN', baseTemp: 31, condition: 'Partly Cloudy', icon: '02d', humidity: 64, windSpeed: 14, uv: 7, pressure: 1012, visibility: 8, rainProb: 35 },
  khandala: { name: 'Khandala', state: 'Maharashtra', country: 'IN', baseTemp: 27, condition: 'Cool Breeze', icon: '02d', humidity: 70, windSpeed: 12, uv: 6, pressure: 1013, visibility: 9, rainProb: 25 },
  wardha: { name: 'Khandala', state: 'Maharashtra', country: 'IN', baseTemp: 27, condition: 'Cool Breeze', icon: '02d', humidity: 70, windSpeed: 12, uv: 6, pressure: 1013, visibility: 9, rainProb: 25 },
